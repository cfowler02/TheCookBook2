...
module.exports = {
  ...
  entry: {
    ...
    createFoodRecipe: path.resolve(__dirname, 'src', 'pages', 'createFoodRecipe.js'),
    viewFoodRecipe: path.resolve(__dirname, 'src', 'pages', 'viewFoodRecipe.js'),
    getFoodRecipes: path.resolve(__dirname, 'src', 'pages', 'getFoodRecipes.js'),
